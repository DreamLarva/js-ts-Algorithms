...
assert_1.default.strictEqual(
  detectCycle((0, LinkedList_1.createLinkedList)([1], -1)),
  null
);
assert_1.default.strictEqual(
  detectCycle((0, LinkedList_1.createLinkedList)([3, 2, 0, -4], 1)).val,
  2
);
assert_1.default.strictEqual(
  detectCycle((0, LinkedList_1.createLinkedList)([1, 2], 0)).val,
  1
);
assert_1.default.strictEqual(
  detectCycle((0, LinkedList_1.createLinkedList)([1], 0)).val,
  1
);

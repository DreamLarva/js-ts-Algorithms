...
assert_1.default.deepStrictEqual(
  rotateRight(LinkedList_1.createLinkedList([1, 2, 3, 4, 5]), 2).toString(),
  [4, 5, 1, 2, 3]
);
assert_1.default.deepStrictEqual(
  rotateRight(LinkedList_1.createLinkedList([0, 1, 2]), 4).toString(),
  [2, 0, 1]
);
assert_1.default.deepStrictEqual(
  rotateRight(LinkedList_1.createLinkedList([1, 2]), 1).toString(),
  [2, 1]
);

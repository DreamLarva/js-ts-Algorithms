...
assert_1.default.deepStrictEqual(
  removeNthFromEnd(
    LinkedList_1.createLinkedList([1, 2, 3, 4, 5]),
    2
  ).toString(),
  [1, 2, 3, 5]
);
assert_1.default.deepStrictEqual(
  removeNthFromEnd(LinkedList_1.createLinkedList([1]), 1),
  null
);
assert_1.default.deepStrictEqual(
  removeNthFromEnd(LinkedList_1.createLinkedList([1, 2]), 1).toString(),
  [1]
);
assert_1.default.deepStrictEqual(
  removeNthFromEnd(LinkedList_1.createLinkedList([1, 2]), 2).toString(),
  [2]
);

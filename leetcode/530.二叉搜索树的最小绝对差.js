...
assert_1.default.strictEqual(
  getMinimumDifference1((0, BinaryTree_1.createBinaryTree)([1, null, 3, 2])),
  1
);
assert_1.default.strictEqual(
  getMinimumDifference2((0, BinaryTree_1.createBinaryTree)([1, null, 3, 2])),
  1
);
assert_1.default.strictEqual(
  getMinimumDifference3((0, BinaryTree_1.createBinaryTree)([1, null, 3, 2])),
  1
);

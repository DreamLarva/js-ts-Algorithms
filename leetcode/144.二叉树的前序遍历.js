...
assert_1.default.deepStrictEqual(preorderTraversal((0, BinaryTree_1.createBinaryTree)([1, null, 2, 3])), [
    1,
    2,
    3,
]);
assert_1.default.deepStrictEqual(preorderTraversal_1((0, BinaryTree_1.createBinaryTree)([1, null, 2, 3])), [
    1,
    2,
    3,
]);

...
assert_1.default.deepStrictEqual((0, assertHelper_1.sortDeep)(threeSum([-1, 0, 1, 2, -1, -4])), (0, assertHelper_1.sortDeep)([
    [-1, -1, 2],
    [-1, 0, 1],
]));
assert_1.default.deepStrictEqual((0, assertHelper_1.sortDeep)(threeSum([-1, 0, 1, 2, -1, -4, -1, 0, 1, 2, -1, -4, 0])), (0, assertHelper_1.sortDeep)([
    [-4, 2, 2],
    [-1, -1, 2],
    [-1, 0, 1],
    [0, 0, 0],

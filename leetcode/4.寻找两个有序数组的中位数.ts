...
assert.strictEqual(findMedianSortedArrays([3, 4], [1, 2]), 2.5);
assert.strictEqual(findMedianSortedArrays([3], [1, 2]), 2);
assert.strictEqual(findMedianSortedArrays([1, 2], [3]), 2);
assert.strictEqual(findMedianSortedArrays([3, 6, 8, 9], [1, 2]), 4.5);

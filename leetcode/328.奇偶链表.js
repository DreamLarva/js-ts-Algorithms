...
assert_1.default.deepStrictEqual(oddEvenList((0, LinkedList_1.createLinkedList)([1, 2, 3, 4])).toString(), [1, 3, 2, 4]);
assert_1.default.deepStrictEqual(oddEvenList((0, LinkedList_1.createLinkedList)([1])).toString(), [1]);
assert_1.default.deepStrictEqual(oddEvenList((0, LinkedList_1.createLinkedList)([1, 2])).toString(), [
    1,
    2,
]);
assert_1.default.deepStrictEqual(oddEvenList((0, LinkedList_1.createLinkedList)([1, 2, 3])).toString(), [
    1,
    3,
    2,
]);
assert_1.default.deepStrictEqual(oddEvenList((0, LinkedList_1.createLinkedList)([1, 2, 3, 4])).toString(), [1, 3, 2, 4]);
assert_1.default.deepStrictEqual(oddEvenList((0, LinkedList_1.createLinkedList)([1, 2, 3, 4, 5])).toString(), [1, 3, 5, 2, 4]);

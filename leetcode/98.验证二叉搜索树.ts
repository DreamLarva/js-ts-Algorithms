...
assert.strictEqual(isValidBST(createBinaryTree([])), true);
assert.strictEqual(isValidBST(createBinaryTree([1, 1])), false);
assert.strictEqual(isValidBST(createBinaryTree([2, 1, 3])), true);
assert.strictEqual(isValidBST(createBinaryTree([5, 3, 7, 2, 4, 6, 8])), true);
assert.strictEqual(isValidBST(createBinaryTree([5, 3, 7, 2, 10, 6, 8])), false);
assert.strictEqual(
